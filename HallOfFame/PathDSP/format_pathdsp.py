...
def format_entry(iteration, sample, batch_size, learning_rate, dropout, metric, result, walltime):
    return (iteration, sample, batch_size, learning_rate, dropout, metric, result, walltime)
        ...
        for file_path in files:
            with open(file_path, 'r') as in_csv:
                ...
                for row in reader:
                    ...
                    entry = format_entry(iteration, sample, batch_size, learning_rate, dropout, 'val_loss', val_loss, 0)
...
def write_output_file(data_entries, output_file):
    with open(output_file, 'w', newline='') as out_csv:
        ...
        writer.writerow(['iteration', 'sample', 'batch_size', 'learning_rate', 'dropout', 'metric', 'result', 'walltime'])
